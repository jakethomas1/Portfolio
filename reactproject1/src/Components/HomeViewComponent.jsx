        ...
        <>
            ...
            >
                ...
                <div className="relative w-1/2 h-full bg-[#181818] vignette border-l-[1px] border-black">
                    <div id="homepage_text_container" className="text-white absolute top-[45%] left-[50%] translate-[-50%] flex flex-col items-center">
                        {bio1}
