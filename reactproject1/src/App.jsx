...
function App() {
    ...
    return (
        <>
            ...
            <div id="projectsview" className="bg-[#0f0f0f] shadow-[0_2px_18px_rgba(0,0,0,.3)] relative z-10">
                ...
                <div
                    id="ProjectsComponent_container"
                        className="flex flex-col justify-center items-center md:grid md:grid-cols-[repeat(auto-fit,minmax(500px,1fr))] gap-x-[32px] gap-y-24 pt-32 pb-42 mx-auto w-full 
            ...
            <div id="timelineview" className="relative z-5">
                <TimelineComponent />
            </div>
